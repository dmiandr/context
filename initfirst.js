...
//    testnestedre		// регулярное выражение для проверки по url, не является ли событие подчиненным данному. Одновеменно является признаком, что на этой странице у комментариев нет уникальных идентификаторов
//    userelem          // Элемент, соответсвующий имени пользователя. Именно у него изменяется стиль при назначении статуса (см colorAll). По умолчанию собвпадает с базовым.

//! Инициализация всех основных полей структуры значениями по умолчанию
